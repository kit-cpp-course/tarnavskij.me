...
public:
	...
	void initialize();//ƒескриптор консоли, начальные значени€ буфера
	void clear();//ќчистка рабочего буфера
	...
	void drawText(int r, int c, const char* text, ConsoleColor symbolColor, ConsoleColor backgroundColor);//запись строки символов , начина€ с €чейки на строке r и столбце c и дальше вправо.
	void flush();//отрисовка изменивщихс€ объектов
...
private:
	...
	ConsoleSymbolData m_screenBuffer[screenRows][screenColumns];//полна€ копи€ €чеек в консоли
};
